...
2. **Presentation Summary:** Read the provided presentation notes or summary. Summarize the overall quality of the presentation, focusing on the clarity, enthusiasm, and flow of the demo. If the summary is empty or short, state "No presentation notes provided for analysis." Label this section clearly as "PRESENTATION SUMMARY:".
...
3.  **Justify** each score with a concise, analytical reason (3-4 sentences maximum).
...
"""
    ...
    with st.spinner("Stage 1: Running Summarization Chain (Analyzing PDF and YouTube summary)..."):
        try:
            summary_inputs = {
            ...
            st.markdown("---")
            st.subheader("✅ Summarization Chain Output (Internal Use)")
